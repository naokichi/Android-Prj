...
import com.android_mvc.sample_project.activities.func_html.JqueryMobileWorkActivity;
        ...
        else
        {
            ...
            Router.goByRoutingTable(
                    ...
                    new RoutingTable()
                            ...
                            .map("JQUERY_SAMPLE", SampleJQueryMobileActivity.class,
                                    "jQuery Mobileのサンプル画面へ")
                            .map("ANIM_SAMPLE", SampleAnimationActivity.class, "アニメーションのサンプル画面へ")
                            .map("JQUERY_WORK", JqueryMobileWorkActivity.class)
                    );
        }
